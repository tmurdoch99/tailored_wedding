...
class RsvpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rsvp" do
    assert_difference('Rsvp.count') do
      post rsvps_url, params: { rsvp: { name: @rsvp.name, other: @rsvp.other, preference: @rsvp.preference, user_id: @rsvp.user_id } }
    end
  ...
  test "should update rsvp" do
    patch rsvp_url(@rsvp), params: { rsvp: { name: @rsvp.name, other: @rsvp.other, preference: @rsvp.preference, user_id: @rsvp.user_id } }
